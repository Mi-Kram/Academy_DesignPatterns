...
public class CustomCheckersFactory extends CheckersFactory {
  ...
  public CheckerView[] createCheckers() {
    ...
    view1.set(1, 1, CheckerColor.Black, CheckerType.Simple, CheckerStyle.Steel);
    view2.set(3, 1, CheckerColor.Black, CheckerType.Simple, CheckerStyle.Steel);
    view3.set(1, 5, CheckerColor.White, CheckerType.King, CheckerStyle.Steel);
